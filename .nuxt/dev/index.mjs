...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, getQuery as getQuery$1, getRequestWebStream, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, readBody, getResponseStatusText } from 'file:///Users/jose/Dev/bingo/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, join, dirname } from 'node:path';
import crypto$1 from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/jose/Dev/bingo/node_modules/@vue/shared/dist/shared.cjs.js';
import viteNodeEntry_mjs from 'file:///Users/jose/Dev/bingo/node_modules/@nuxt/vite-builder/dist/vite-node-entry.mjs';
import { viteNodeFetch } from 'file:///Users/jose/Dev/bingo/node_modules/@nuxt/vite-builder/dist/vite-node.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/jose/Dev/bingo/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, encodePath, joinRelativeURL } from 'file:///Users/jose/Dev/bingo/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/jose/Dev/bingo/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file:///Users/jose/Dev/bingo/node_modules/vue/server-renderer/index.mjs';
import { createHooks } from 'file:///Users/jose/Dev/bingo/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/jose/Dev/bingo/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/jose/Dev/bingo/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/jose/Dev/bingo/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/jose/Dev/bingo/node_modules/unstorage/drivers/fs.mjs';
import { mkdir, writeFile, rename, unlink, readFile } from 'node:fs/promises';
import fsDriver from 'file:///Users/jose/Dev/bingo/node_modules/unstorage/drivers/fs-lite.mjs';
import lruCache from 'file:///Users/jose/Dev/bingo/node_modules/unstorage/drivers/lru-cache.mjs';
import { digest, hash as hash$1 } from 'file:///Users/jose/Dev/bingo/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/jose/Dev/bingo/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/jose/Dev/bingo/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/jose/Dev/bingo/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/jose/Dev/bingo/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/jose/Dev/bingo/node_modules/radix3/dist/index.mjs';
import consola, { consola as consola$1 } from 'file:///Users/jose/Dev/bingo/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/jose/Dev/bingo/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/jose/Dev/bingo/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/jose/Dev/bingo/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/jose/Dev/bingo/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/jose/Dev/bingo/node_modules/errx/dist/index.mjs';
import { isVNode, isRef, toValue } from 'file:///Users/jose/Dev/bingo/node_modules/vue/index.mjs';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file:///Users/jose/Dev/bingo/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///Users/jose/Dev/bingo/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/jose/Dev/bingo/node_modules/unhead/dist/server.mjs';
import { walkResolver } from 'file:///Users/jose/Dev/bingo/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/jose/Dev/bingo/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/jose/Dev/bingo","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/jose/Dev/bingo/server","watchOptions":{"ignored":[null]}}));
storage.mount('cache:nuxt:payload', cacheDriver({"base":"/Users/jose/Dev/bingo/.nuxt/cache/nuxt/payload"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/jose/Dev/bingo/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/jose/Dev/bingo/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/jose/Dev/bingo/.data/kv"}));
...
const _Uw67hJ2mmXjNkZVaklgQhtm8VHfEzkyup95_wIHawQ = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/jose/Dev/bingo";

const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Genera e imprime cartones de Bingo personalizados con temática de las Fiestas Patrias de Chile. Ideal para celebrar en familia y fondas."},{"name":"theme-color","content":"#d97706"}],"link":[{"rel":"icon","type":"image/svg+xml","href":"/favicon.svg"},{"rel":"preconnect","href":"https://fonts.googleapis.com"},{"rel":"preconnect","href":"https://fonts.gstatic.com","crossorigin":""},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Luckiest+Guy&family=Nunito:wght@400;700;900&display=swap"}],"style":[],"script":[],"noscript":[],"title":"Bingo CHILENO - Generador de Cartones de Fiestas Patrias"};
...
const _mkmaeGhLqaKr17OOtTOnuBUEsicqae1rsZS90Vufk = (nitroApp) => {
...
const plugins = [
  _Uw67hJ2mmXjNkZVaklgQhtm8VHfEzkyup95_wIHawQ,
_mkmaeGhLqaKr17OOtTOnuBUEsicqae1rsZS90Vufk,
...
const _ViLd3W = eventHandler((event) => {
...
const _lazy_P1v85b = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _ViLd3W, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_P1v85b, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_P1v85b, lazy: true, middleware: false, method: undefined }
];
